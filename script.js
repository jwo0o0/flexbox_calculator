...
buttons.addEventListener('click', function (event) {
    ...
    if (target.matches('button')) {
        ...
        if (action === 'number') {
            ...
            //firstOperend 가 0이면 -> firstOperend
            //               0이 아니면 -> secondOperend 
...
const display = document.querySelector('.calculator__display--2'); // calculator__display 엘리먼트와, 그 자식 엘리먼트의 정보를 모두 담고 있습니다.
